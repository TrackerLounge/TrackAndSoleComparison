...
public class FFTFilter implements  PlugInFilter, Measurements {
    ...
    public void setFilterLargeDia(double filterLargeDia) {
    	this.filterLargeDia = filterLargeDia;
    }
    
    public void setFilterSmallDia(double filterSmallDia) {
    	this.filterSmallDia = filterSmallDia;
    }
    ...
    public int setup(String arg, ImagePlus imp) {
        ...
        if (!showBandpassDialog(imp, filterLargeDia, filterSmallDia))
            return DONE;
        else
    ...
    */
    ...
    //double filterLargeDia = 40.0;
    //double  filterSmallDia = 3.0;
    boolean showBandpassDialog(ImagePlus imp) {
        ...
        //NOTE: I hide the showDialog() to allow greater automation
        //gd.showDialog();
        //NOTE: I hide the showDialog() to allow greater automation
    ...
    //double filterLargeDia = 40.0;
    //double  filterSmallDia = 3.0;
    boolean showBandpassDialog(ImagePlus imp, double filterLargeDia, double  filterSmallDia) {
        if (imp.getCompositeMode()==IJ.COMPOSITE)
            processStack = true;
        GenericDialog gd = new GenericDialog("FFT Bandpass Filter");
        gd.addNumericField("Filter_large structures down to", filterLargeDia, 0, 4, "pixels");
